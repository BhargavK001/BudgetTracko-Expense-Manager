        ...
        <View style={[styles.container, { paddingTop: insets.top }]}>
            ...
            <View style={styles.stickyHeader}>
                ...
                <TouchableOpacity style={styles.addButton}>
                    <Ionicons name="add" size={16} color={DarkTheme.brandYellow} />
            ...
            >
                ...
                <View style={styles.overviewRow}>
                    <BalanceOverviewCard label="Available Balance" masked={!showBalance} amount="₹16,728" />
                ...
                <View style={styles.section}>
                    ...
                    <AccountCard name="Slice" masked={!showBalance} balance="₹16,728" />
                </View>
                ...
                <View style={styles.section}>
                    ...
                    <AccountCard name="Bank Account" masked={!showBalance} balance="₹0" />
                </View>
                ...
                <View style={styles.section}>
                    ...
                    <AccountCard name="Cash" masked={!showBalance} balance="₹0" />
                </View>
